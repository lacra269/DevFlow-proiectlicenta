...
import MobileMenu from "./MobileMenu"; // Presupunem că acest component există și gestionează corect sesiunea/logout-ul pentru mobil
    ...
    <div className="h-20 md:h-24 bg-white border-b border-gray-100 sticky top-0 z-50">
      <div className="container mx-auto max-w-6xl h-full flex items-center justify-between px-4 md:px-6 lg:px-8 gap-4">
        ...
        <div className="flex-shrink-0">
          <Link
            href="/app" // Link către pagina principală a aplicației
        ...
        <div className="hidden lg:flex flex-grow justify-start px-4 min-w-0">
          {/* Margin-left ml-40 este destul de mare; poate necesita ajustare pentru un design responsiv mai bun 
              sau dacă se dorește centrarea reală a barei de căutare în spațiul disponibil.
              Pentru centrarea reală, ai putea folosi mx-auto pe div-ul cu max-w-2xl și justify-center pe părinte.
          */}
          <div className="relative w-full max-w-2xl ml-40"> 
            ...
            <input
              type="text"
              placeholder="Caută proiecte, discuții, utilizatori..." // Deja în română
        ...
        {/* Dreapta: Acțiuni Utilizator & Meniu Mobil */}
        <div className="flex items-center justify-end gap-2 md:gap-4 flex-shrink-0">
          ...
          <div className="hidden md:flex items-center gap-3">
            {isLoading ? (
              ...
              <>
                ...
                {/* Logout cu redirecționare */}
                <button 
                  onClick={() => signOut({ callbackUrl: '/' })} // MODIFICAT: Adăugat callbackUrl
              ...
              <button
                onClick={() => signIn('github')} // Poți adăuga și alți provideri sau o pagină de login custom
              ...
              >
                <LogIn size={16} />
                <span>Autentificare</span> {/* TRADUS: Din "Login" în "Autentificare" */}
              </button>
            )}
          </div>
          {/* Meniu Mobil */}
          <div className="md:hidden">
            ...
            {/* Asigură-te că și MobileMenu implementează signOut({ callbackUrl: '/' }) dacă are buton de logout */}
          </div>
        </div>
      </div>
    </div>
